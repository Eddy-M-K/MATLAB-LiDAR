...
hold on 
Perpendicular_Rotated_LiDAR_Emission_Pattern(FOV_Start, FOV_End, Lower_Angle, Upper_Angle, 30, Radius_Start, 10, LiDAR_x, LiDAR_y, LiDAR_z)
[sphere_moving_x4, sphere_moving_y4, sphere_moving_z4] = Trajectory_Generation_Selection(dt);

hold off
figure 
hold on
C = Perpendicular_Rotated_Precise_Moving_Golf_Ball_Intersection(Precise_Azimuth, sphere_moving_x4, sphere_moving_y4, sphere_moving_z4, r, Precise_Azimuth_Resolution, Radius_Start, 30, LiDAR_x, LiDAR_y, LiDAR_z);
